                ...
                <div class="customerLandingLeftDiv">
                    ...
                    <div class="customerLandingLeft">
                        ...
                        <div class="customerLandingCustomerParent">
                            <div onmousedown="customerLandingProfilePress(this);" class="customerLandingCustomerTitle"><?php echo $_SESSION['orderName']; ?>
                            ...
                            <div class="customerLandingCustomerChild">
                    ...
                    <div class="customerLandingLeft hide">
                        ...
                        <div class="customerLandingCustomerParent">
                            <div onmousedown="customerLandingProfilePress(this);" class="customerLandingCustomerTitle"><?php echo $_SESSION['name']; ?>
                                <svg class="up" viewBox="0 0 24 24"><path d="M7.41 15.41L12 10.83l4.59 4.58L18 14l-6-6-6 6z"></path></svg>
                                <svg class="down" viewBox="0 0 24 24"><path d="M7.41 7.84L12 12.42l4.59-4.58L18 9.25l-6 6-6-6z"></path></svg>
                            </div>
                            <form class="customerLandingCustomerChild" method="POST" action="../javascripts/customerForm.php">
